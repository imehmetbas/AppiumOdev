...
public class StepImplementation extends BaseTest {
    ...
    @Step({"<xpath> xpath'li elementi bulana kadar swipe et"})
    public void findByKeyWithSwipe(String xpath) {
        ...
        while (maxRetryCount > 0) {
            ...
            if (elements!=null) {
                if (elements.get(0).isDisplayed() == false) {
                    ...
                    System.out.println(xpath + " element bulundu. DOWN");
                    break;
                }
            } else {
                System.out.println(xpath + " else girdi. DOWN");
                swipeDownAccordingToPhoneSize();
            }
        }
    }
    ...
    @Step("<xpath> xpath'li elementi rasgele sec")
    public void chooseRandomProduct(String xpath) {
    ...
    @Step("<xpath> xpath'li element varsa tikla")
    public void clickAcceptbuttonxpath(String xpath) throws InterruptedException {
